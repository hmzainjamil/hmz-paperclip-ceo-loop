...
> Paperclip AI autonomous CEO loop — monitors KPIs, approves low-risk decisions, delegates tasks to MAE agents, and maintains company OS state.
...
|---|---|---|
| [Core System](bin/) | `bin/` | All automation scripts for hmz-paperclip-ceo-loop — MAE integrated |
