...
<p align="center">
  ...
  <a href="https://github.com/hmzainjamil/hmz-paperclip-ceo-loop/issues">Issues</a> ·
  <a href="https://github.com/hmzainjamil/hmz-paperclip-ceo-loop/commits/main">Commits</a>
</p>
<p align="center">
  <img alt="Last commit" src="https://img.shields.io/github/last-commit/hmzainjamil/hmz-paperclip-ceo-loop.svg">
  <img alt="Repository size" src="https://img.shields.io/github/repo-size/hmzainjamil/hmz-paperclip-ceo-loop.svg">
...
> Paperclip AI autonomous CEO loop — monitors KPIs, approves low-risk decisions, delegates tasks to MAE agents, maintains company OS state.
...
|---|---|---|
| [Paperclip-Ceo-Loop Core](bin/) | `bin/` | Primary automation scripts and tools for hmz-paperclip-ceo-loop |
